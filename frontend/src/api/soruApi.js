...
// endpoint'leri (GET /api/sorular, POST /api/sorular, DELETE /api/sorular/{soru_id})
// burada bağlıdır; istek/yanıt şekli ~/Desktop/kontratlar.txt "ANKET SORULARI
// LİSTESİ" ve "ANKET SORUSU EKLEME" bloklarıyla birebir. Oturum httpOnly cookie
// ile taşındığından credentials:'include' zorunludur.
